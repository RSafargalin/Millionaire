...
final class SearchView: UIView {
    ...
    func getSwitchSearchButton(target: UIViewController, action: Selector) -> UIBarButtonItem {
        let button = UIBarButtonItem(title: "Search music", style: .plain, target: target, action: action)
